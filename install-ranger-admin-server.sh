...
ldap_domain=bnb.internal                                  ## 根据实际环境修改
ldap_server_url=ldap://172.31.46.68:389                   ## 根据实际环境修改
ldap_base_dn=ou=tech,dc=bnb,dc=internal                   ## 根据实际环境修改
ldap_bind_user_dn=uid=ranger,ou=tech,dc=bnb,dc=internal   ## 根据实际环境修改
ldap_bind_password=123456                                 ## 根据实际环境修改
